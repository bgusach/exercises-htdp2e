...
(define SUBBACKGROUND-WIDTH 300)
(define SUBBACKGROUND-HEIGHT 180)
(define BACKGROUND 
  (beside
    (empty-scene SUBBACKGROUND-WIDTH SUBBACKGROUND-HEIGHT "green")
    (empty-scene SUBBACKGROUND-WIDTH SUBBACKGROUND-HEIGHT "blue")
    (empty-scene SUBBACKGROUND-WIDTH SUBBACKGROUND-HEIGHT "red")))
